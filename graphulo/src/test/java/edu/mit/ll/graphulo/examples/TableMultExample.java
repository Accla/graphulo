 ...
 * (2) multiply transpose(A) * A and store the result in Accumulo table C.
 */
...
//    Map<String,String> sumOptions = new HashMap<>();
    ...
    bs.close();
    System.out.println("# of entries in output table "+outputTable+": "+cnt);

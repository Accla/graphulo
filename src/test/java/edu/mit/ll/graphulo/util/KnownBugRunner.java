 ...
 * Effect: for any test method annotated with {@link edu.mit.ll.graphulo.util.KnownBug},
    ...
    public Statement apply(final Statement base, final Description description) {
      return new Statement() {
        ...
        public void evaluate() throws Throwable {
          ...
          KnownBug kb = description.getAnnotation(KnownBug.class);
          try {
            base.evaluate();
            if (kb != null)
              log.info("KnownBug Fixed: "+kb.value()+" ["+testclassname+'#'+testmethodname+']');
          } catch (AssumptionViolatedException e) {
            // some other assumption failed
            throw e;
          } catch (Throwable e) {
            if (kb != null) {
              log.info("KnownBug Test Failure: "+kb.value()+" ["+testclassname+'#'+testmethodname+']',e);
              throw new AssumptionViolatedException("KnownBug Test Failure: "+kb.value(), e);
            } else {
              throw e;
            }
          }

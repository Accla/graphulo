...
public class TestTableSplit {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, CBException, CBSecurityException, TableNotFoundException, MutationsRejectedException, TableExistsException, InterruptedException, D4mException 
	{
		...
		//Do table split
		tableOp.addSplits(tableName,partitionKeys.toString());
